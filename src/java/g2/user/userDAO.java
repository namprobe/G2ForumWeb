...
public class userDAO {
    ...
    public userDTO select(String user_ID) throws SQLException, ClassNotFoundException {
        Connection con = null;
        ResultSet rs = null;
        PreparedStatement stm = null;
        userDTO acc = null;
    ...
    public void update(userDTO acc){
        Connection con = null;
        PreparedStatement stm = null;
        try{
            String query = "update userTbl set username = ?,password=?,email=?,birthdate=?";
